...
current_relative_humidity = float(input())

# 산불위험지수 계산
fire_hazard_index = calculate_fire_danger_index(current_temperature, current_relative_humidity)

# 결과 출력
print("산불위험지수:", fire_hazard_index)